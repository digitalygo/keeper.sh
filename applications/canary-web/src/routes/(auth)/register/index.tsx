...
import { Button, ExternalLinkButton, ButtonText, ButtonIcon, LinkButton } from "../../../components/ui/button";
  ...
  return (
    <Provider>
      <div className="flex flex-col py-2">
        <Heading2 as="span" className="text-center">Create your account</Heading2>
        <Text size="sm" tone="muted" align="center">Get started with Keeper for free</Text>
      </div>
      ...
      <ExternalLinkButton href="/auth/outlook" className="w-full justify-center" variant="border">
        ...
        <ButtonText>Sign up with Outlook</ButtonText>
      </ExternalLinkButton>
      <Divider>or</Divider>
      <EmailForm />
      <Text size="sm" tone="muted" align="center">
        Already have an account? <Link to="/login" className="text-foreground underline underline-offset-2 hover:text-foreground-muted transition-colors">Sign in</Link>
      </Text>
    </Provider>
  );
}
