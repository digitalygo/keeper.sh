...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      border: "border-border text-foreground bg-background hover:backdrop-brightness-95 active:backdrop-brightness-90 disabled:backdrop-brightness-90 dark:hover:backdrop-brightness-150 dark:active:backdrop-brightness-175 dark:disabled:backdrop-brightness-175",
