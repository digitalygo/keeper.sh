...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      border: "border-border text-foreground bg-background hover:enabled:backdrop-brightness-95 active:enabled:backdrop-brightness-90 disabled:backdrop-brightness-90 dark:hover:enabled:backdrop-brightness-150 dark:active:enabled:backdrop-brightness-175 dark:disabled:backdrop-brightness-175",
